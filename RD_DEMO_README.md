...
2. 使用統計
   - 日 / 月 / 年切換，可分別選擇開始與結束日期、月份或年度；顯示總提問數、使用人數、每人每月用量前 10 名、部門提問次數前 10 名與 KMS 引用文件排名。回饋率集中於回饋管理，不在此頁重複呈現。
...
4. 回饋管理
   - 可選擇回饋日期區間，以簡易圓環圖顯示正向（7-10 分）與負向（1-6 分）的筆數及百分比；逐筆顯示使用者、部門、代理人、原始問題、被評分回答段落及留言，後臺管理者只需填寫備註，不設處理狀態。
...
4. 切到「使用統計」，切換日 / 月 / 年並選擇起訖時間；查看每人每月用量前 10 名、部門提問次數前 10 名及 KMS 引用文件排名。
5. 切到「稽核日誌」，確認只顯示錯誤 / 異常事件，再查看人員 / 時間 / 操作類型篩選、事件原因、Trace ID、資料快照與 Token 用量異常通知。
6. 切到「回饋管理」，選擇日期區間並查看正負向回饋圖表，再確認使用者、部門、代理人、分數、留言與被評分回答段落，最後填寫管理者備註。
