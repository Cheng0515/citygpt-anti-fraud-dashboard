...
2. 使用統計
   - 上一日 / 上週 / 上個月完整區間、總提問數、使用人數、正向回饋率、每人每月用量排名、部門與角色提問次數、KMS 引用文件排名。
   - 超過 300,000 Token 的個人告警送往監控端，不在統計頁另設「用量異常人數」KPI；統計報表匯出需求待縣府確認。
3. 稽核日誌
...
4. 切到「使用統計」，切換上一日 / 上週 / 上個月並確認實際日期區間；查看每人每月用量排名、部門與角色提問次數及 KMS 引用文件排名。
